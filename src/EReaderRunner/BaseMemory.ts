...
export class BaseMemory {
  ...
  public missingMemoryValue: number | undefined = undefined;
  ...
  public setValueAt(address: number, value: number) {
    ...
    // console.log("setValueAt", { address, index, value });
    this.memory[index] = value;
  }
  ...
  public getValueAt(address: number) {
    ...
    const value = this.memory[index] ?? this.missingMemoryValue;
    // console.log("getValueAt", { address, index, value });
    return value;
  }
