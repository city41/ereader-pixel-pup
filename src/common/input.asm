; just common defines for input
    ...
    ERAPI_KEY_A      = 0x0001
    ERAPI_KEY_B      = 0x0002
    ERAPI_KEY_A_B    = ERAPI_KEY_A + ERAPI_KEY_B
    ...
    ERAPI_KEY_LEFT_RIGHT   = ERAPI_KEY_RIGHT + ERAPI_KEY_LEFT
    ERAPI_KEY_LRUD   = ERAPI_KEY_RIGHT + ERAPI_KEY_LEFT + ERAPI_KEY_DOWN + ERAPI_KEY_UP
