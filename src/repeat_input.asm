...
;;
    ...
    _I_REPEAT_SPEED_SWITCH_COUNT = 2
...
_i_process_repeat:
    ...
    ;; has there been enough repeated movements for a speed switch? if so, move to fast speed
    cp _I_REPEAT_SPEED_SWITCH_COUNT
    jr nc, input_read__repeat__set_fast_duration ;; a >= _I_REPEAT_SPEED_SWITCH_COUNT
